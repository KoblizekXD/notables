...
export default async function UserNote({ title, entity, createdAt }: props) {
  return (
    <Link
      href={`/notes/${title}`}
      className="border-2 shrink min-w-38 border-solid border-gray-300 dark:border-neutral-800 rounded-xl p-4 h-auto flex flex-col gap-y-4 lg:w-auto max-w-66 hover:shadow-[0_2px_8px_rgba(0,0,0,0.3)] duration-300 transition-all">

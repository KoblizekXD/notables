...
export default async function UserDescription() {
    ...
    const descriptionText = "lol";

    return (
        <div className="flex flex-col gap-y-6 items-center justify-center rounded-xl w-full h-full ">
            {descriptionText !== null ? (
                <p className="max-h-full overflow-auto p-2 py-3 border-2 border-solid border-transparent hover:border-accent transition-colors duration-150 rounded-bl-xl rounded-tl-xl text-gray-500 dark:text-gray-400">    

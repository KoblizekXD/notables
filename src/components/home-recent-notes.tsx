  ...
  return recentNotes.length !== 0 ? (
    <div className="grid grid-cols-1   lg:grid-cols-[3fr_7fr] w-full h-full rounded-xl gap-6 border border-border shadow-md p-6">
      ...
      <div className="flex flex-col h-full w-full gap-3 justify-between">
        ...
        <div className="flex justify-center md:justify-end pt-2">
          <div className="group bg-foreground text-background py-2 px-3 rounded-lg relative overflow-hidden">
            <div className="absolute inset-0 bg-primary w-0 transition-[width] duration-500 group-hover:w-full rounded-lg" />
            <Link
              href={""}
              className="relative inline-flex items-center text-lg z-10">
      ...
      <CarouselContent className="p-2">
        {recentNotes.map((i, index) => (
          <CarouselItem
            ...
            <div className=" overflow-hidden group hover:scale-105 w-full h-32 bg-input/10 hover:bg-input/40 rounded-xl box-border hover:shadow-md shadow transition-all duration-400 py-4 px-6 border border-border select-none ">

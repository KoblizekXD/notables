      ...
      <div className="flex flex-col items-center justify-center gap-16">
        ...
        <section id="whyUs" className="flex flex-col items-center justify-center gap-8">
          ...
          <div className="flex flex-row justify-between px-6 max-w-[90%] flex-wrap">
            <div className="flex flex-col justify-between px-4 py-6 border-2 border-solid border-[#d7d7da] dark:border-[#27272a] rounded-xl gap-6">
              ...
              <div className="border-2 border-solid border-gray-200 dark:border-[#27272a] rounded-xl flex flex-col justify-between items-center">
                <div className="flex items-center justify-between w-full p-1 px-2">
                  <h1 className="text-xl font-bold">Heading</h1>
                  <div className="flex gap-x-2">
                    <button
                      className="cursor-default bg-slate-200 text-[#0F172A] rounded-lg px-2 py-2"
                      disabled={true}
                    >
                      Save
                    </button>
                    <button
                      className="cursor-default bg-slate-900 text-white rounded-lg px-2 py-2
                    flex items-center"
                      disabled={true}
                    >
                      Post
                ...
                <div className="flex flex-col items-start">
                  <div className="flex items-center pr-2 py-2">
                    <p className="border-r-2 border-solid border-black h-6 flex items-center">Lorem ipsum dolor sit amet cons{" "}</p>

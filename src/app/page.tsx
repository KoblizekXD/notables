...
import { CornerLeftDown, ArrowUpRight, TextCursor, Check } from "lucide-react";
...
export default function Home() {
  return (
    <main className="min-h-screen w-screen max-w-screen border items-center flex flex-col lg:gap-28 md:gap-38 gap-60 overflow-auto">
      ...
      <div className="text-center lg:mt-[30vh] md:mt-[24vh] mt-[18vh] flex gap-y-3 flex-col items-center md:p-4 px-6">
      ...
      <div className="flex flex-col items-center justify-center gap-32">
        <div className="flex flex-col items-center justify-center gap-32">
          ...
          <div className="grid lg:flex-row lg:grid-cols-3 grid-cols-1 justify-between px-6 flex-wrap gap-12">
              ...
              <div className="border-2 border-solid border-gray-200 dark:border-zinc-800 rounded-xl flex flex-col justify-between items-center">
                <div className="flex items-center justify-between w-full p-1 px-2">
                  ...
                  <div className="flex gap-x-2">
                    ...
                    <button
                      type="button"
                      className="cursor-default bg-slate-900 select-none text-white rounded-lg px-2 py-2 flex items-center"
                      disabled={true}
                    >
                      Post
                      <ArrowUpRight />
            ...
            <div className="flex flex-col justify-between px-4 py-6 border-2 border-solid border-[#d7d7da] dark:border-zinc-800 rounded-xl gap-6 max-w-84">
              ...
              <div className="border-2 border-solid border-gray-200 dark:border-zinc-800 rounded-xl flex flex-col justify-between items-center">
                <div className="grid grid-cols-2 gap-2 p-1 px-2">
                  <div className="bg-[#a3a3a3] p-5 lg:p-3 items-center justify-center flex border-2 border-solid border-[#777777] rounded-xl">
                    Albert Einstein
                  </div>
                  <div className="bg-[#5DEE83] p-5 lg:p-3 items-center justify-center flex border-2 border-solid border-[#47a660] rounded-xl">
                    <Check color="#47a660" />
                  </div>
                  <div className="bg-[#5DEE83] p-5 lg:p-3 items-center justify-center flex border-2 border-solid border-[#47a660] rounded-xl">
                    <Check color="#47a660" />

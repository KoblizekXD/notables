...
export default function Home() {
  return (
    <main className="min-h-screen w-screen max-w-screen border items-center flex flex-col lg:gap-28 md:gap-38 gap-60 overflow-auto">
      <ThemeBasedRenderer
        light={
          <div className="absolute inset-0 -z-10 h-full w-full bg-white bg-[radial-gradient(#e5e7eb_1px,transparent_1px)] [background-size:16px_16px]" />
        }
      />
      <Logo className="absolute left-1 top-3" />
      ...
      <div className="flex flex-col items-center justify-center gap-32">
        <div className="flex flex-col  items-center justify-center gap-32">
          ...
          <div className="grid max-w-screen lg:flex-row lg:grid-cols-3 grid-cols-1 justify-between px-6 flex-wrap gap-12">
            <div className="flex flex-col justify-between px-4 py-6 border-2 border-solid border-[#d7d7da] dark:border-zinc-800 rounded-xl gap-6 max-w-84">
              ...
              <div className="border-2 border-solid border-gray-200 dark:border-zinc-800 rounded-xl flex flex-col justify-between items-center shadow-md min-w-[265px]">
            ...
            <div className="flex flex-col justify-between px-4 py-6 border-2 border-solid border-[#d7d7da] dark:border-zinc-800 rounded-xl gap-6 max-w-84">
              ...
              <div className="border-2 border-solid border-gray-200 dark:border-zinc-800 rounded-xl flex flex-row justify-between items-start shadow-md lg:p-5 p-3 gap-x-3 min-w-[265px]">
                <Avatar>
            ...
            <div className="flex flex-col justify-between px-4 py-6 border-2 border-solid border-[#d7d7da] dark:border-zinc-800 rounded-xl gap-6 max-w-84">
              ...
              <div className="border-2 border-solid border-gray-200 dark:border-zinc-800 rounded-xl flex flex-col justify-between items-center shadow-md min-w-[265px]">
                <div className="grid grid-cols-2 gap-2 p-1 px-2">
                  <div className="bg-[#a3a3a3] p-5 lg:py-6 lg:p-3 items-center justify-center flex border-2 border-solid border-[#777777] rounded-xl">
                    Albert Einstein
                  </div>
                  <div className="bg-[#5DEE83] p-5 lg:py-6 lg:p-3 items-center justify-center flex border-2 border-solid border-[#47a660] rounded-xl">
                    <Check color="#47a660" size={40} />
                  </div>
                  <div className="bg-[#5DEE83] p-5 lg:py-6 lg:p-3 items-center justify-center flex border-2 border-solid border-[#47a660] rounded-xl">
                    <Check color="#47a660" size={40} />
                  </div>

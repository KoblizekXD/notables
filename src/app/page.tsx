...
import { CornerLeftDown, ArrowUpRight, TextCursor, Check, CalendarDays, Copyright } from "lucide-react";
...
export default function Home() {
  return (
    <div className="flex flex-col items-center justify-center gap-20">
      ...
      <footer className="flex py-6 mx-auto items-center gap-3">
        <div>
          <Copyright size={20} /> caune
        </div>
        Created by: 
